...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { category: @dish.category, description: @dish.description, name: @dish.name, price: @dish.price }
    end
  ...
  test "should update dish" do
    patch :update, id: @dish, dish: { category: @dish.category, description: @dish.description, name: @dish.name, price: @dish.price }
    assert_redirected_to dish_path(assigns(:dish))
  end
